...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDto createOrder(CreateOrderRequest orderDto) {
        ...
        //fetch cart
        Cart cart = cartRepository.findById(cartId).orElseThrow(() -> new ResourceNotFoundException("Cart of given id not found"));
    ...
    public List<OrderDto> getOrdersOfUser(String userId) {
        ...
        List<OrderDto> collect = orders.stream().map(order -> mapper.map(order, OrderDto.class)).collect(Collectors.toList());
